...
$LNG['intro_welcome']		= "Welcome to xNova Revolution!";
$LNG['intro_text']			= "One of the best clones of OGame is xNova Revolutions.<br>The latest is and xNova Revolution the stablest flat rate was ever developed. xNova Revolution shines by stability, flexibility, dynamics, quality and user-friendliness. We hope always to be better than her expectations.<br><br>The installation system guides you through the install or upgrade from an older version to the latest. On questions or trouble don't hesitate to contact us.<br><br>xNova Revolution is an open source project licensed under the GNU GPL v3. For the license please click on the item in the menu.<br><br>Before the installation starts, a test is conducted, if system requirements are met.";
